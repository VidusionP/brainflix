...
const url = 'https://brainflix-backend.herokuapp.com/videos'
...
class Home extends Component {
    ...
    componentDidMount(){
        ...
        axios.get(`https://brainflix-backend.herokuapp.com/videos/1af0jruup5gu`)
            .then(response => {
                this.setState({
    ...
    componentDidUpdate( prevProps){
        ...
        if(prevProps.match.params.id !== this.props.match.params.id){
            axios.get(`https://brainflix-backend.herokuapp.com/videos/${params.id}`)
                .then(response => {
                    this.setState({
                        mainVideo: response.data,
                    })
